					...
					echo '
						...
						<form action="payment_success.php" method="get">
							...
							echo   
								...
								<br><br>
								<a href="/Ecommerce-app-h/payment_success.php" style="color:Black; text-decoration:none;"><input style="float:right;margin-right:80px;" type="submit" name="submit" value="Proceed with Payment" style="font-size:20px;"></a>
							</form>';
				}
			}
	}
