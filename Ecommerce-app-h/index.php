	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="index.html" class="navbar-brand">TrustUs</a>
			</div>
					...
					<ul class="dropdown-menu">
						<div style="width:300px;">
							<div class="panel panel-primary">
								...
								<div class="panel-heading">
									<form onsubmit="return false" id="login" method="get">
										...
										<br><br>
										<a href="admin/login.php" style="color:white; text-decoration:none;"><input type="button" class="btn btn-warning" value="Login as Admin"></a>
									</form>
								</div>
